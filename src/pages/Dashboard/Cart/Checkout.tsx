...
export default function Checkout() {
  ...
  const [checkoutMethod, setCheckoutMethod] = useState<CheckoutMethod>(CheckoutMethod.Cash);
    ...
    <>
      ...
      <div className="ml-40 text-white pr-16 py-6">
        ...
        <div className="pb-8">
          ...
          <div className="text-sm text-caption pt-0.5">Orders #354262</div>
        </div>
        <div className="flex justify-between space-x-16">
          <div className="basis-7/12 space-y-5">
            <div className="bg-dark-bg rounded-lg px-12 py-6 max-h-80 overflow-y-scroll">
              <div className="flex justify-between items-center pb-2">
                ...
                <div
                  ...
                  onClick={() => setShowingProducts(!showingProducts)}
                >
                  {showingProducts ? "-" : "+"}
                </div>
              </div>
            ...
            <div className="bg-dark-bg rounded-lg px-12 py-6">
              <div className="text-primary font-medium">Order summary</div>
              <div
          ...
          <div className="basis-5/12 space-y-5">
            <div className="bg-dark-bg rounded-lg px-12 py-6">
              ...
              <div className="flex justify-between">
                <div className="flex space-x-3.5 items-start">
                  ...
                  <div>
                    <div>271 Dakao Street, Espresso, Robusta City</div>
            ...
            <div className="bg-dark-bg rounded-lg px-12 py-6">
              ...
              <div className="flex space-x-5">
                <button onClick={() => changeCheckoutMethod(CheckoutMethod.Cash)} className={`w-[100px] h-[64px] ${checkoutMethod === "Cash" ? "bg-primary" : "bg-light"} rounded-lg font-medium flex flex-col justify-center items-center space-y-1`}>
                  <Icons.Cash stroke={checkoutMethod === "Cash" ? "black" : "white"} />
                  <div className={checkoutMethod === "Cash" ? "text-black": "text-white"}>Cash</div>
                </button>
                <button onClick={() => changeCheckoutMethod(CheckoutMethod.Card)} className={`w-[100px] h-[64px] ${checkoutMethod === "Card" ? "bg-primary" : "bg-light"} rounded-lg flex flex-col justify-center items-center space-y-2`}>
                  <Icons.Card stroke={checkoutMethod === "Card" ? "black" : "white"} />
                  <div className={checkoutMethod === "Card" ? "text-black": "text-white"}>Card</div>
                </button>
                <button onClick={() => changeCheckoutMethod(CheckoutMethod.Momo)} className={`w-[100px] h-[64px] ${checkoutMethod === "Momo" ? "bg-primary" : "bg-light"} rounded-lg flex flex-col justify-center items-center space-y-2`}>
                  <Icons.Card stroke={checkoutMethod === "Momo" ? "black" : "white"} />
                  <div className={checkoutMethod === "Momo" ? "text-black": "text-white"}>Momo</div>
                </button>
              </div>
            </div>
            <div className="bg-dark-bg rounded-lg px-12 py-6">

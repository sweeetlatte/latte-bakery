...
export default function SectionTitle({
    ...
    return (
        <div className="relative text-left w-full h-fit">
            <h6 className="font-title text-[200px] xl:text-[160px] lg:text-[120px] text-white-rgba">
                {title}
            </h6>
            <div className="absolute left-[5%] bottom-1/3 flex flex-row items-center justify-between w-[95%]">
                <h6 className="font-title text-7xl xl:text-[3.5rem] lg:text-[2.75rem] text-white">
                    {title}
                </h6>

  ...
  return (
    <div className="text-white bg-dark-bg">
      ...
      <div className="relative h-max px-48 py-20 rounded-l-3xl bg-light ml-[24.5rem]">
        <Link to="/" className="text-primary text-4xl font-semibold font-brand">
          Bakery
        </Link>
        ...
        <form className="mb-16" noValidate>
          <label htmlFor="uname">
            ...
            />
            {errors.name && (
              <p className="error mt-2 text-error">{errors.name}</p>
            )}
          </label>
          <label htmlFor="email">
            ...
            />
            {errors.email && (
              <p className="error mt-2 text-error">{errors.email}</p>
            )}
          </label>
          <label htmlFor="password">
            ...
            />
            {errors.password && (
              <p className="error mt-2 text-error">{errors.password}</p>
            )}
          </label>
          <button
